...
-- AlterTable
ALTER TABLE "BankAccout" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Stack" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "StackCategory" ALTER COLUMN "userId" SET DATA TYPE TEXT;
...
-- AddForeignKey
ALTER TABLE "StackCategory" ADD CONSTRAINT "StackCategory_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BankAccout" ADD CONSTRAINT "BankAccout_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
